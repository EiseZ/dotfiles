...
beautiful.init("/home/eisezimmerman/.config/awesome/theme.lua")


-- This is used later as the default terminal and editor to run.
terminal = "st"
applicaton_launcher = "dmenu_run"
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "space",  function () awful.spawn(applicaton_launcher) end,
    ...
    awful.key({ modkey, "Shift"   }, "d", function () awful.layout.inc(-1)                end,
